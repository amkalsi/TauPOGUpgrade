#ifndef __2NEW_DECAYMODE_NEWD_H_                                                                                                                                          
#define __2NEW_DECAYMODE_NEWD_H_ 
...
class TauIDUpto23New {
    public:
        TauIDUpto23New(std::string prefix,edm::Service<TFileService> fs, const edm::ParameterSet& cfg);
      ~TauIDUpto23New();
