...
TauIDUpto3::TauIDUpto3(std::string prefix,edm::Service<TFileService> fs,const edm::ParameterSet& iConfig)
{
...
void TauIDUpto3::Fill(const edm::Event& iEvent) {
   using namespace edm;
   using namespace std;
...
bool TauIDUpto3::OverlapWithGenTau(double Taueta , double Tauphi , edm::Handle<reco::PFTauCollection> taujetcol, edm::Handle<reco::PFTauDiscriminator>  disc, int &index ) {
...
bool TauIDUpto3::OverlapWithGenTauForOther(double Taueta , double Tauphi , edm::Handle<reco::PFTauCollection> taujetcol, edm::Handle<reco::PFTauDiscriminator>  disc, edm::Handle<reco::PFTauDiscriminator>  disc1 ,int &index ) {
   double drtmp = _TauToGenMatchingDeltaR;
   bool genTaufound = false;
   index = -1;
   for ( unsigned iTau = 0; iTau < taujetcol->size(); ++iTau ) {
...
bool TauIDUpto3::IsZTauTau(edm::Handle<reco::GenParticleCollection> genParticles){
   bool isZTauTau = false;
