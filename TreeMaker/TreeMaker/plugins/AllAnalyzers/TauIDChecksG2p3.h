#ifndef __TAUID_G2P3_CHECK_H_                                                                                                                                          
#define __TAUID_G2P3_CHECK_H_ 
...
class TauIDChecksG2p3 {
    public:
        TauIDChecksG2p3(std::string prefix,edm::Service<TFileService> fs, const edm::ParameterSet& cfg);
      ~TauIDChecksG2p3();
