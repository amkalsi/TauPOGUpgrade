...
TauIDChecks_newDM::TauIDChecks_newDM(std::string prefix,edm::Service<TFileService> fs,const edm::ParameterSet& iConfig)
 {
...
void TauIDChecks_newDM::Fill(const edm::Event& iEvent) {
   using namespace edm;
   using namespace std;
...
bool TauIDChecks_newDM::OverlapWithGenTau(double Taueta , double Tauphi ,edm::Handle<std::vector< reco::GenJet > > genTauJets ,int  &index     ) {
...
bool TauIDChecks_newDM::IsZTauTau(edm::Handle<reco::GenParticleCollection> genParticles){
   bool isZTauTau = false;
