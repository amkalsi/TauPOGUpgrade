...
NewDefinitions_newdmf::NewDefinitions_newdmf(std::string prefix,edm::Service<TFileService> fs,const edm::ParameterSet& iConfig)
{
...
NewDefinitions_newdmf::~NewDefinitions_newdmf()
{
...
void NewDefinitions_newdmf::Fill(const edm::Event& iEvent) {
   using namespace edm;
   using namespace std;
...
bool NewDefinitions_newdmf::OverlapWithGenTau(double Taueta , double Tauphi ,edm::Handle<reco::PFTauCollection> _hpsTaucoll ,int  &index     ) {
...
bool NewDefinitions_newdmf::IsZTauTau(edm::Handle<reco::GenParticleCollection> genParticles){
   bool isZTauTau = false;
