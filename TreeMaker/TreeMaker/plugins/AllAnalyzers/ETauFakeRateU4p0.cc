...
ETauFakeRateU4p0::ETauFakeRateU4p0(std::string prefix,edm::Service<TFileService> fs,const edm::ParameterSet& iConfig)
{
...
ETauFakeRateU4p0::~ETauFakeRateU4p0()
{
...
void ETauFakeRateU4p0::Fill(const edm::Event& iEvent) {
  using namespace edm;
  using namespace std;
...
bool ETauFakeRateU4p0::IsZEE(edm::Handle<reco::GenParticleCollection> genParticles){
   bool isZEE = false;
...
bool ETauFakeRateU4p0::OverlapWithGenMu(double Taueta , double Tauphi ,edm::Handle<reco::GenParticleCollection> genParticles ,int  &index ) {
