#ifndef __GENDECAYMODE_CHECK_H_                                                                                                                                          
#define __GENDECAYMODE_CHECK_H_ 
...
class GenTauDecayModeEfficiency {
    public:
        GenTauDecayModeEfficiency(std::string prefix,edm::Service<TFileService> fs, const edm::ParameterSet& cfg);
      ~GenTauDecayModeEfficiency();
