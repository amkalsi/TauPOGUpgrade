...
JetTauFakeRateFullSimonNew::JetTauFakeRateFullSimonNew(std::string prefix,edm::Service<TFileService> fs,const edm::ParameterSet& iConfig)
{
...
JetTauFakeRateFullSimonNew::~JetTauFakeRateFullSimonNew()
{
...
void JetTauFakeRateFullSimonNew::Fill(const edm::Event& iEvent,const edm::EventSetup& iSetup) {
  using namespace edm;
  using namespace std;
...
pair<bool, reco::Candidate::LorentzVector> JetTauFakeRateFullSimonNew::matchToGenJet(double jeteta , double jetphi , edm::Handle<reco::GenJetCollection> ak5jets) {                        
...
bool JetTauFakeRateFullSimonNew::OverlapWithGenJet(double jeteta , double jetphi ,edm::Handle<reco::GenJetCollection> ak5jets ,int  &index,const edm::Event& iEvent,const edm::EventSetup& iSetup ) {
  double drtmp = _TauToGenMatchingDeltaR;
  int tmpindex =0 ;
  bool jetfound = false;
