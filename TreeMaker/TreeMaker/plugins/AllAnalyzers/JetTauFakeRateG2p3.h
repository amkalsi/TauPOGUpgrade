#ifndef __JET_FAKERATE_G2p3_H_                                                                                                                                          
#define __JET_FAKERATE_G2p3_H_ 
...
class JetTauFakeRateG2p3 {
    public:
        JetTauFakeRateG2p3(std::string prefix, edm::Service<TFileService> fs, const edm::ParameterSet& cfg);
      ~JetTauFakeRateG2p3();
