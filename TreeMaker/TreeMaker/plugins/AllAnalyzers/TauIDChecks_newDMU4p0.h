#ifndef __TAUID_NEW_CHECK_U4p0_H_                                                                                                                                          
#define __TAUID_NEW_CHECK_U4p0_H_ 
...
class TauIDChecks_newDMU4p0 {
    public:
        TauIDChecks_newDMU4p0(std::string prefix,edm::Service<TFileService> fs, const edm::ParameterSet& cfg);
      ~TauIDChecks_newDMU4p0();
