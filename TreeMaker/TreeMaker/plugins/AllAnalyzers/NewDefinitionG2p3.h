#ifndef __DEFINITION_CHEC_ETA2P3_H_                                                                                                                                          
#define __DEFINITION_CHEC_ETA2P3_H_ 
...
class NewDefinitionG2p3 {
    public:
        NewDefinitionG2p3(std::string prefix,edm::Service<TFileService> fs, const edm::ParameterSet& cfg);
      ~NewDefinitionG2p3();
