#ifndef __MUON_FAKERATE_U4p0_H_                                                                                                                                          
#define __MUON_FAKERATE_U4p0_H_ 
...
class MuTauFakeRateU4p0 {
    public:
        MuTauFakeRateU4p0(std::string prefix, edm::Service<TFileService> fs, const edm::ParameterSet& cfg);
      ~MuTauFakeRateU4p0();
