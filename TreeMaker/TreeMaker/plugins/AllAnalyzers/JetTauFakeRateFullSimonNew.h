#ifndef __JET_IS_FAKERATE_FULL_H_              
#define __JET_IS_FAKERATE_FULL_H_ 
...
class JetTauFakeRateFullSimonNew {
    public:
        JetTauFakeRateFullSimonNew(std::string prefix, edm::Service<TFileService> fs, const edm::ParameterSet& cfg);
      ~JetTauFakeRateFullSimonNew();
