#include "./GenTauDecayModeEfficiency.h"                                                                                                                                        
  

GenTauDecayModeEfficiency::GenTauDecayModeEfficiency(std::string prefix,edm::Service<TFileService> fs,const edm::ParameterSet& iConfig)
 {
 ...
 hFillTauHcal3x3OverPLead  = fs->make<TH1F>(("hFillTauHcal3x3OverPLead"+prefix).c_str() ,"hFillTauHcal3x3OverPLead",500,0,50);
 FillHOverP  = fs->make<TH1F>(("FillHOverP"+prefix).c_str() ,"FillHOverP",500,0,50);
 FillEOverP  = fs->make<TH1F>(("FillEOverP"+prefix).c_str() ,"FillEOverP",500,0,50); 
 FillGammaFraction = fs->make<TH1F>(("FillGammaFraction"+prefix).c_str() ,"FillGammaFraction",500,0,5);

 hFillTauHcal3x3OverPLead_before  = fs->make<TH1F>(("hFillTauHcal3x3OverPLead_before"+prefix).c_str() ,"hFillTauHcal3x3OverPLead_befor",500,0,50);
 FillHOverP_before  = fs->make<TH1F>(("FillHOverP_before"+prefix).c_str() ,"FillHOverP_before",500,0,50);
 FillEOverP_before  = fs->make<TH1F>(("FillEOverP_before"+prefix).c_str() ,"FillEOverP_brfore",500,0,50); 
 FillGammaFraction_before = fs->make<TH1F>(("FillGammaFraction_before"+prefix).c_str() ,"FillGammaFraction_before",500,0,5);

 hFillTauHcal3x3OverPLead_DMF  = fs->make<TH1F>(("hFillTauHcal3x3OverPLead_DMF"+prefix).c_str() ,"hFillTauHcal3x3OverPLead_DMF",500,0,50);
 FillHOverP_DMF  = fs->make<TH1F>(("FillHOverP_DMF"+prefix).c_str() ,"FillHOverP_DMF",500,0,50);
 FillEOverP_DMF  = fs->make<TH1F>(("FillEOverP_DMF"+prefix).c_str() ,"FillEOverP_DMF",500,0,50); 
 FillGammaFraction_DMF = fs->make<TH1F>(("FillGammaFraction_DMF"+prefix).c_str() ,"FillGammaFraction_DMF",500,0,5);
...
hFillTauHcal3x3OverPLead_DMF  = fs->make<TH1F>(("hFillTauHcal3x3OverPLead_DMF"+prefix).c_str() ,"hFillTauHcal3x3OverPLead_DMF",500,0,50);
 ...
 hFillTauHcal3x3OverPLead_NewDMF  = fs->make<TH1F>(("hFillTauHcal3x3OverPLead_NewDMF"+prefix).c_str() ,"hFillTauHcal3x3OverPLead_NewDMF",500,0,50);
 FillHOverP_NewDMF  = fs->make<TH1F>(("FillHOverP_NewDMF"+prefix).c_str() ,"FillHOverP_NewDMF",500,0,50);
 FillEOverP_NewDMF  = fs->make<TH1F>(("FillEOverP_NewDMF"+prefix).c_str() ,"FillEOverP_NewDMF",500,0,50); 
 FillGammaFraction_NewDMF = fs->make<TH1F>(("FillGammaFraction_NewDMF"+prefix).c_str() ,"FillGammaFraction_NewDMF",500,0,5);
...
GenTauDecayModeEfficiency::~GenTauDecayModeEfficiency()
{
...
void GenTauDecayModeEfficiency::Fill(const edm::Event& iEvent) {
   using namespace edm;
   using namespace std;
...
bool GenTauDecayModeEfficiency::OverlapWithGenTau(double Taueta , double Tauphi ,edm::Handle<std::vector< reco::GenJet > > genTauJets ,int  &index     ) {
...
bool GenTauDecayModeEfficiency::IsZTauTau(edm::Handle<reco::GenParticleCollection> genParticles){
   bool isZTauTau = false;
