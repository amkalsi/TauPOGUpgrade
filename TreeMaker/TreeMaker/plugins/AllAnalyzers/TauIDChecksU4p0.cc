...
TauIDChecksU4p0::TauIDChecksU4p0(std::string prefix,edm::Service<TFileService> fs,const edm::ParameterSet& iConfig)
 {
...
void TauIDChecksU4p0::Fill(const edm::Event& iEvent) {
   using namespace edm;
   using namespace std;
...
bool TauIDChecksU4p0::OverlapWithGenTau(double Taueta , double Tauphi ,edm::Handle<std::vector< reco::GenJet > > genTauJets ,int  &index     ) {
...
bool TauIDChecksU4p0::IsZTauTau(edm::Handle<reco::GenParticleCollection> genParticles){
   bool isZTauTau = false;
