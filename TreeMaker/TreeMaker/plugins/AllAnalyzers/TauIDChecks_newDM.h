#ifndef __TAUID_NEW_CHECK_H_                                                                                                                                          
#define __TAUID_NEW_CHECK_H_ 
...
class TauIDChecks_newDM {
    public:
        TauIDChecks_newDM(std::string prefix,edm::Service<TFileService> fs, const edm::ParameterSet& cfg);
      ~TauIDChecks_newDM();
