#ifndef __ELEC_FAKERATE_U4P0_H_                                                                                                                                          
#define __ELEC_FAKERATE_U4P0_H_ 
...
class ETauFakeRateU4p0 {
    public:
        ETauFakeRateU4p0(std::string prefix, edm::Service<TFileService> fs, const edm::ParameterSet& cfg);
      ~ETauFakeRateU4p0();
...
//  Handle<reco::PFTauDiscriminator> _hpsTau,_hpsTau1,_hpsTau2,_hpsTau3,_chargedIsoPtSum,_neutralIsoPtSum,_pucorrPtSum,_rawCharged;
 ...
 Handle<reco::PFTauDiscriminator> _dmf,_mv1,_mv2,_mv3,_mv31,_mv32,_ev1,_ev2,_ev3,_iso1,_iso2,_iso3,_iso4,_iso5,_iso6, _hpsTau,_hpsTau1,_hpsTau2,_hpsTau3,_chargedIsoPtSum,_neutralIsoPtSum,_pucorrPtSum,_rawCharged ,_enew; 
