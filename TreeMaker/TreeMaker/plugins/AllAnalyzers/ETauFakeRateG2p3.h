#ifndef __ELEC_FAKERATE_G2P3_H_                                                                                                                                          
#define __ELEC_FAKERATE_G2P3_H_ 
...
class ETauFakeRateG2p3 {
    public:
        ETauFakeRateG2p3(std::string prefix, edm::Service<TFileService> fs, const edm::ParameterSet& cfg);
      ~ETauFakeRateG2p3();
