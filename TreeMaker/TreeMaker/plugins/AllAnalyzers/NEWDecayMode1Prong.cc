...
NEWDecayMode1Prong::NEWDecayMode1Prong(std::string prefix,edm::Service<TFileService> fs,const edm::ParameterSet& iConfig)
{
...
NEWDecayMode1Prong::~NEWDecayMode1Prong()
{
...
void NEWDecayMode1Prong::Fill(const edm::Event& iEvent) {
   using namespace edm;
   using namespace std;
...
bool NEWDecayMode1Prong::OverlapWithGenTau(double Taueta , double Tauphi , edm::Handle<reco::PFTauCollection> taujetcol, edm::Handle<reco::PFTauDiscriminator>  disc, int &index ) {
...
bool NEWDecayMode1Prong::OverlapWithGenTauForOther(double Taueta , double Tauphi , edm::Handle<reco::PFTauCollection> taujetcol, edm::Handle<reco::PFTauDiscriminator>  disc, edm::Handle<reco::PFTauDiscriminator>  disc1 ,int &index ) {
   double drtmp = _TauToGenMatchingDeltaR;
   bool genTaufound = false;
   index = -1;
   for ( unsigned iTau = 0; iTau < taujetcol->size(); ++iTau ) {
...
bool NEWDecayMode1Prong::IsZTauTau(edm::Handle<reco::GenParticleCollection> genParticles){
   bool isZTauTau = false;
