#ifndef __MUON_FAKERATE_G2p3_H_                                                                                                                                          
#define __MUON_FAKERATE_G2p3_H_ 
...
class MuTauFakeRateG2p3 {
    public:
        MuTauFakeRateG2p3(std::string prefix, edm::Service<TFileService> fs, const edm::ParameterSet& cfg);
      ~MuTauFakeRateG2p3();
