#ifndef __JET_FAKERATE_UIH_FULL_H_                                                                                                                                          
#define __JET_FAKERATE_UIH_FULL_H_ 
...
class JetTauFakeRateFullNDM {
    public:
        JetTauFakeRateFullNDM(std::string prefix, edm::Service<TFileService> fs, const edm::ParameterSet& cfg);
      ~JetTauFakeRateFullNDM();
