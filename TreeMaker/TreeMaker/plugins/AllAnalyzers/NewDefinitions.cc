...
NewDefinitions::NewDefinitions(std::string prefix,edm::Service<TFileService> fs,const edm::ParameterSet& iConfig)
{
  ...
  hFillTauHcal3x3OverPLead_NewDMF  = fs->make<TH1F>(("hFillTauHcal3x3OverPLead_NewDMF"+prefix).c_str() ,"hFillTauHcal3x3OverPLead_NewDMF",1000,0,50);
  FillHOverP_NewDMF  = fs->make<TH1F>(("FillHOverP_NewDMF"+prefix).c_str() ,"FillHOverP_NewDMF",1000,0,50);
  FillEOverP_NewDMF  = fs->make<TH1F>(("FillEOverP_NewDMF"+prefix).c_str() ,"FillEOverP_NewDMF",1000,0,30); 
  FillGammaFraction_NewDMF = fs->make<TH1F>(("FillGammaFraction_NewDMF"+prefix).c_str() ,"FillGammaFraction_NewDMF",1000,0,5);
  ...
  TauPtResponse_DM3Prong1pi0LChar  = fs->make<TH1F>(("TauPtResponse_DM3Prong1pi0LChar"+prefix).c_str() ,"TauPtResponse_DM3Prong1pi0LChar",100,0.1,2.0);
  ...
  TauPtResponse_DM3Prong1pi0  = fs->make<TH1F>(("TauPtResponse_DM3Prong1pi0"+prefix).c_str() ,"TauPtResponse_DM3Prong1pi0",100,0.1,2.0); 
  ...
  TauPtResponse_DM1Prong1pi0LChar  = fs->make<TH1F>(("TauPtResponse_DM1Prong1pi0LChar"+prefix).c_str() ,"TauPtResponse_DM1Prong1pi0LChar",100,0.1,2.0);
  ...
  TauPtResponse_DM1Prong1pi0  = fs->make<TH1F>(("TauPtResponse_DM1Prong1pi0"+prefix).c_str() ,"TauPtResponse_DM1Prong1pi0",100,0.1,2.0); 
  ...
  TauPtResponse_DM1Prong2pi0LChar  = fs->make<TH1F>(("TauPtResponse_DM1Prong2pi0LChar"+prefix).c_str() ,"TauPtResponse_DM1Prong2pi0LChar",100,0.1,2.0);
  ...
  TauPtResponse_DM1Prong2pi0  = fs->make<TH1F>(("TauPtResponse_DM1Prong2pi0"+prefix).c_str() ,"TauPtResponse_DM1Prong2pi0",100,0.1,2.0); 
  ...
  TauPtResponse_DM1ProngLChar  = fs->make<TH1F>(("TauPtResponse_DM1ProngLChar"+prefix).c_str() ,"TauPtResponse_DM1ProngLChar",100,0.1,2.0);
  
  TauPtResponse_NDM1Prong  = fs->make<TH1F>(("TauPtResponse_NDM1Prong"+prefix).c_str() ,"TauPtResponse_NDM1Prong",100,0.1,2.0);
  TauPtResponse_DM1Prong  = fs->make<TH1F>(("TauPtResponse_DM1Prong"+prefix).c_str() ,"TauPtResponse_DM1Prong",100,0.1,2.0); 
  ...
  TauPtResponse_DM3ProngLChar  = fs->make<TH1F>(("TauPtResponse_DM3ProngLChar"+prefix).c_str() ,"TauPtResponse_DM3ProngLChar",100,0.1,2.0);
  
  TauPtResponse_NDM3Prong  = fs->make<TH1F>(("TauPtResponse_NDM1Prong"+prefix).c_str() ,"TauPtResponse_NDM1Prong",100,0.1,2.0);
  TauPtResponse_DM3Prong  = fs->make<TH1F>(("TauPtResponse_DM1Prong"+prefix).c_str() ,"TauPtResponse_DM1Prong",100,0.1,2.0); 
...
//  GenTauPhiWithoutDMF = fs->make<TH1F>(("GenTauPhiWithoutDMF", "GenTauPhiWithoutDMF",100,-5,5);
  ...
  GenTauPtWithNewDMF = fs->make<TH1F>(("GenTauPtWithNewDMF"+prefix).c_str() ,"GenTauPtWithNewDMF",100,0,700);
  GenTauEtaWithNewDMF = fs->make<TH1F>(("GenTauEtaWithNewDMF"+prefix).c_str() ,"GenTauEtaWithNewDMF",100,-5,5);
  GenTauPhiWithNewDMF = fs->make<TH1F>(("GenTauPhiWithNewDMF"+prefix).c_str() ,"GenTauPhiWithNewDMF",100,-5,5);
  ...
  GenTauPt_DM1Prong = fs->make<TH1F>(("GenTauPt_DM1Prong"+prefix).c_str() ,"GenTauPt_DM1Prong" ,100,0,700);
  GenTauEta_DM1Prong = fs->make<TH1F>(("GenTauEta_DM1Prong"+prefix).c_str() ,"GenTauEta_DM1Prong" ,100,-5,5);
  GenTauPhi_DM1Prong = fs->make<TH1F>(("GenTauPhi_DM1Prong"+prefix).c_str() ,"GenTauPhi_DM1Prong" ,100,-5,5);

  GenTauPt_DM1Prong1pi0 = fs->make<TH1F>(("GenTauPt_DM1Prong1pi0"+prefix).c_str() ,"GenTauPt_DM1Prong1pi0" ,100,0,700);
  GenTauEta_DM1Prong1pi0 = fs->make<TH1F>(("GenTauEta_DM1Prong1pi0"+prefix).c_str() ,"GenTauEta_DM1Prong1pi0" ,100,-5,5);
  GenTauPhi_DM1Prong1pi0 = fs->make<TH1F>(("GenTauPhi_DM1Prong1pi0"+prefix).c_str() ,"GenTauPhi_DM1Prong1pi0" ,100,-5,5);

  GenTauPt_DM1Prong2pi0 = fs->make<TH1F>(("GenTauPt_DM1Prong2pi0"+prefix).c_str() ,"GenTauPt_DM1Prong2pi0" ,100,0,700);
  GenTauEta_DM1Prong2pi0 = fs->make<TH1F>(("GenTauEta_DM1Prong2pi0"+prefix).c_str() ,"GenTauEta_DM1Prong2pi0" ,100,-5,5);
  GenTauPhi_DM1Prong2pi0 = fs->make<TH1F>(("GenTauPhi_DM1Prong2pi0"+prefix).c_str() ,"GenTauPhi_DM1Prong2pi0" ,100,-5,5);

  GenTauPt_DM3Prong = fs->make<TH1F>(("GenTauPt_DM3Prong"+prefix).c_str() ,"GenTauPt_DM3Prong" ,100,0,700);
  GenTauEta_DM3Prong = fs->make<TH1F>(("GenTauEta_DM3Prong"+prefix).c_str() ,"GenTauEta_DM3Prong" ,100,-5,5);
  GenTauPhi_DM3Prong = fs->make<TH1F>(("GenTauPhi_DM3Prong"+prefix).c_str() ,"GenTauPhi_DM3Prong" ,100,-5,5);

  GenTauPt_DM3Prong1pi0 = fs->make<TH1F>(("GenTauPt_DM3Prong1pi0"+prefix).c_str() ,"GenTauPt_DM3Prong1pi0" ,100,0,700);
  GenTauEta_DM3Prong1pi0 = fs->make<TH1F>(("GenTauEta_DM3Prong1pi0"+prefix).c_str() ,"GenTauEta_DM3Prong1pi0" ,100,-5,5);
  GenTauPhi_DM3Prong1pi0 = fs->make<TH1F>(("GenTauPhi_DM3Prong1pi0"+prefix).c_str() ,"GenTauPhi_DM3Prong1pi0" ,100,-5,5);
...
GenTauPtWithDMF_eta1p47_0 = fs->make<TH1F>(("GenTauPtWithDMF_eta1p47_0"+prefix).c_str() ,"GenTauPtWithDMF_eta1p47_0",100,0,700);
 ...
 GenTauPtWithDMF_0 = fs->make<TH1F>(("GenTauPtWithDMF_0"+prefix).c_str() ,"GenTauPtWithDMF_0",100,0,700);
  ...
  hNeutralIsoPtSumWeight1 = fs->make<TH1F>(("hNeutralIsoPtSumWeight1"+prefix).c_str() ,"hNeutralIsoPtSumWeight1",800,0,400); 
  hNeutralIsoPtSumWeight2 = fs->make<TH1F>(("hNeutralIsoPtSumWeight2"+prefix).c_str() ,"hNeutralIsoPtSumWeight2",800,0,400); 
  hNeutralIsoPtSumWeight1NQ = fs->make<TH1F>(("hNeutralIsoPtSumWeight1NQ"+prefix).c_str() ,"hNeutralIsoPtSumWeight1NQ",800,0,400); 
  hNeutralIsoPtSumWeight2NQ = fs->make<TH1F>(("hNeutralIsoPtSumWeight2NQ"+prefix).c_str() ,"hNeutralIsoPtSumWeight2NQ",800,0,400); 
 
  hNeutralHadronIsoPtSum  = fs->make<TH1F>(("hNeutralHadronIsoPtSum"+prefix).c_str() ,"hNeutralHadronIsoPtSum",800,0,400);
  hNeutralHadronIsoPtSumWeight1 = fs->make<TH1F>(("hNeutralHadronIsoPtSumWeight1"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight1",800,0,400);
  hNeutralHadronIsoPtSumWeight2 = fs->make<TH1F>(("hNeutralHadronIsoPtSumWeight2"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight2",800,0,400);
  hNeutralHadronIsoPtSumWeight1NQ = fs->make<TH1F>(("hNeutralHadronIsoPtSumWeight1NQ"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight1NQ",800,0,400);
  hNeutralHadronIsoPtSumWeight2NQ = fs->make<TH1F>(("hNeutralHadronIsoPtSumWeight2NQ"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight2NQ",800,0,400);
  hChargedIsoPtSum  = fs->make<TH1F>(("hChargedIsoPtSum"+prefix).c_str(),"hChargedIsoPtSum",800,0,400); 
  hNeutralIsoPtSum = fs->make<TH1F>(("hNeutralIsoPtSum"+prefix).c_str(),"hNeutralIsoPtSum",800,0,400);
  hPUcorrPtSum = fs->make<TH1F>(("hPUcorrPtSum"+prefix).c_str(),"hPUcorrPtSum",800,0,400);
 ...
 hNeutralIsoPtSumWeight2NQ_dmf = fs->make<TH1F>(("hNeutralIsoPtSumWeight2NQ_dmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight2NQ_dmf",800,0,400);
  ...
  hNeutralIsoPtSumWeight1_Newdmf = fs->make<TH1F>(("hNeutralIsoPtSumWeight1_Newdmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight1_Newdmf",800,0,400);
 hNeutralIsoPtSumWeight2_Newdmf = fs->make<TH1F>(("hNeutralIsoPtSumWeight2_Newdmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight2_Newdmf",800,0,400);
 hNeutralIsoPtSumWeight1NQ_Newdmf = fs->make<TH1F>(("hNeutralIsoPtSumWeight1NQ_Newdmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight1NQ_Newdmf",800,0,400);
 hNeutralIsoPtSumWeight2NQ_Newdmf = fs->make<TH1F>(("hNeutralIsoPtSumWeight2NQ_Newdmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight2NQ_Newdmf",800,0,400);


  hNeutralHadronIsoPtSum_Newdmf  = fs->make<TH1F>(("hNeutralHadronIsoPtSum_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSum_Newdmf",800,0,400);
  hNeutralHadronIsoPtSumWeight1_Newdmf = fs->make<TH1F>(("hNeutralHadronIsoPtSumWeight1_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight1_Newdmf",800,0,400);
  hNeutralHadronIsoPtSumWeight2_Newdmf = fs->make<TH1F>(("hNeutralHadronIsoPtSumWeight2_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight2_Newdmf",800,0,400);
  hNeutralHadronIsoPtSumWeight1NQ_Newdmf = fs->make<TH1F>(("hNeutralHadronIsoPtSumWeight1NQ_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight1NQ_Newdmf",800,0,400);
  hNeutralHadronIsoPtSumWeight2NQ_Newdmf = fs->make<TH1F>(("hNeutralHadronIsoPtSumWeight2NQ_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight2NQ_Newdmf",800,0,400);
  hChargedIsoPtSum_Newdmf  = fs->make<TH1F>(("hChargedIsoPtSum_Newdmf"+prefix).c_str(),"hChargedIsoPtSum_Newdmf",800,0,400); 
  hNeutralIsoPtSum_Newdmf = fs->make<TH1F>(("hNeutralIsoPtSum_Newdmf"+prefix).c_str(),"hNeutralIsoPtSum_Newdmf",800,0,400);
  hPUcorrPtSum_Newdmf = fs->make<TH1F>(("hPUcorrPtSum_Newdmf"+prefix).c_str(),"hPUcorrPtSum_Newdmf",800,0,400);


  /// After Decay Mode Finding

  hNeutralIsoPtSumWeight1_pt_Newdmf = fs->make<TProfile>(("hNeutralIsoPtSumWeight1_pt_Newdmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight1_pt_Newdmf",400,0,700,0,400); 
  hNeutralIsoPtSumWeight2_pt_Newdmf = fs->make<TProfile>(("hNeutralIsoPtSumWeight2_pt_Newdmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight2_pt_Newdmf",400,0,700,0,400); 
  hNeutralIsoPtSumWeight1NQ_pt_Newdmf = fs->make<TProfile>(("hNeutralIsoPtSumWeight1NQ_pt_Newdmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight1NQ_pt_Newdmf",400,0,700,0,400); 
  hNeutralIsoPtSumWeight2NQ_pt_Newdmf = fs->make<TProfile>(("hNeutralIsoPtSumWeight2NQ_pt_Newdmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight2NQ_pt_Newdmf",400,0,700,0,400); 
  hNeutralHadronIsoPtSum_pt_Newdmf  = fs->make<TProfile>(("hNeutralHadronIsoPtSum_pt_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSum_pt_Newdmf",400,0,700,0,400);
  hNeutralHadronIsoPtSumWeight1_pt_Newdmf = fs->make<TProfile>(("hNeutralHadronIsoPtSumWeight1_pt_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight1_pt_Newdmf",400,0,700,0,400);
  hNeutralHadronIsoPtSumWeight2_pt_Newdmf = fs->make<TProfile>(("hNeutralHadronIsoPtSumWeight2_pt_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight2_pt_Newdmf",400,0,700,0,400);
  hNeutralHadronIsoPtSumWeight1NQ_pt_Newdmf = fs->make<TProfile>(("hNeutralHadronIsoPtSumWeight1NQ_pt_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight1NQ_pt_Newdmf",400,0,700,0,400);
  hNeutralHadronIsoPtSumWeight2NQ_pt_Newdmf = fs->make<TProfile>(("hNeutralHadronIsoPtSumWeight2NQ_pt_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight2NQ_pt_Newdmf",400,0,700,0,400);
  hChargedIsoPtSum_pt_Newdmf  = fs->make<TProfile>(("hChargedIsoPtSum_pt_Newdmf"+prefix).c_str(),"hChargedIsoPtSum_pt_Newdmf",400,0,700,0,400); 
  hNeutralIsoPtSum_pt_Newdmf = fs->make<TProfile>(("hNeutralIsoPtSum_pt_Newdmf"+prefix).c_str(),"hNeutralIsoPtSum_pt_Newdmf",400,0,700,0,400);
  hPUcorrPtSum_pt_Newdmf = fs->make<TProfile>(("hPUcorrPtSum_pt_Newdmf"+prefix).c_str(),"hPUcorrPtSum_pt_Newdmf",400,0,700,0,400);

  hNeutralIsoPtSumWeight1_eta_Newdmf = fs->make<TProfile>(("hNeutralIsoPtSumWeight1_eta_Newdmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight1_eta_Newdmf",200,-5,5,0,400); 
  hNeutralIsoPtSumWeight2_eta_Newdmf = fs->make<TProfile>(("hNeutralIsoPtSumWeight2_eta_Newdmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight2_eta_Newdmf",200,-5,5,0,400); 
  hNeutralIsoPtSumWeight1NQ_eta_Newdmf = fs->make<TProfile>(("hNeutralIsoPtSumWeight1NQ_eta_Newdmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight1NQ_eta_Newdmf",200,-5,5,0,400); 
  hNeutralIsoPtSumWeight2NQ_eta_Newdmf = fs->make<TProfile>(("hNeutralIsoPtSumWeight2NQ_eta_Newdmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight2NQ_eta_Newdmf",200,-5,5,0,400); 
  hNeutralHadronIsoPtSum_eta_Newdmf  = fs->make<TProfile>(("hNeutralHadronIsoPtSum_eta_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSum_eta_Newdmf",200,-5,5,0,400);
  hNeutralHadronIsoPtSumWeight1_eta_Newdmf = fs->make<TProfile>(("hNeutralHadronIsoPtSumWeight1_eta_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight1_eta_Newdmf",200,-5,5,0,400);
  hNeutralHadronIsoPtSumWeight2_eta_Newdmf = fs->make<TProfile>(("hNeutralHadronIsoPtSumWeight2_eta_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight2_eta_Newdmf",200,-5,5,0,400);
  hNeutralHadronIsoPtSumWeight1NQ_eta_Newdmf = fs->make<TProfile>(("hNeutralHadronIsoPtSumWeight1NQ_eta_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight1NQ_eta_Newdmf",200,-5,5,0,400);
  hNeutralHadronIsoPtSumWeight2NQ_eta_Newdmf = fs->make<TProfile>(("hNeutralHadronIsoPtSumWeight2NQ_eta_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight2NQ_eta_Newdmf",200,-5,5,0,400);
  hChargedIsoPtSum_eta_Newdmf  = fs->make<TProfile>(("hChargedIsoPtSum_eta_Newdmf"+prefix).c_str(),"hChargedIsoPtSum_eta_Newdmf",200,-5,5,0,400); 
  hNeutralIsoPtSum_eta_Newdmf = fs->make<TProfile>(("hNeutralIsoPtSum_eta_Newdmf"+prefix).c_str(),"hNeutralIsoPtSum_eta_Newdmf",200,-5,5,0,400);
  hPUcorrPtSum_eta_Newdmf = fs->make<TProfile>(("hPUcorrPtSum_eta_Newdmf"+prefix).c_str(),"hPUcorrPtSum_eta_Newdmf",200,-5,5,0,400);


  hNeutralIsoPtSumWeight1_phi_Newdmf = fs->make<TProfile>(("hNeutralIsoPtSumWeight1_phi_Newdmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight1_phi_Newdmf",200,-5,5,0,400); 
  hNeutralIsoPtSumWeight2_phi_Newdmf = fs->make<TProfile>(("hNeutralIsoPtSumWeight2_phi_Newdmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight2_phi_Newdmf",200,-5,5,0,400); 
  hNeutralIsoPtSumWeight1NQ_phi_Newdmf = fs->make<TProfile>(("hNeutralIsoPtSumWeight1NQ_phi_Newdmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight1NQ_phi_Newdmf",200,-5,5,0,400); 
  hNeutralIsoPtSumWeight2NQ_phi_Newdmf = fs->make<TProfile>(("hNeutralIsoPtSumWeight2NQ_phi_Newdmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight2NQ_phi_Newdmf",200,-5,5,0,400); 
  hNeutralHadronIsoPtSum_phi_Newdmf  = fs->make<TProfile>(("hNeutralHadronIsoPtSum_phi_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSum_phi_Newdmf",200,-5,5,0,400);
  hNeutralHadronIsoPtSumWeight1_phi_Newdmf = fs->make<TProfile>(("hNeutralHadronIsoPtSumWeight1_phi_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight1_phi_Newdmf",200,-5,5,0,400);
  hNeutralHadronIsoPtSumWeight2_phi_Newdmf = fs->make<TProfile>(("hNeutralHadronIsoPtSumWeight2_phi_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight2_phi_Newdmf",200,-5,5,0,400);
  hNeutralHadronIsoPtSumWeight1NQ_phi_Newdmf = fs->make<TProfile>(("hNeutralHadronIsoPtSumWeight1NQ_phi_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight1NQ_phi_Newdmf",200,-5,5,0,400);
  hNeutralHadronIsoPtSumWeight2NQ_phi_Newdmf = fs->make<TProfile>(("hNeutralHadronIsoPtSumWeight2NQ_phi_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight2NQ_phi_Newdmf",200,-5,5,0,400);
  hChargedIsoPtSum_phi_Newdmf  = fs->make<TProfile>(("hChargedIsoPtSum_phi_Newdmf"+prefix).c_str(),"hChargedIsoPtSum_phi_Newdmf",200,-5,5,0,400); 
  hNeutralIsoPtSum_phi_Newdmf = fs->make<TProfile>(("hNeutralIsoPtSum_phi_Newdmf"+prefix).c_str(),"hNeutralIsoPtSum_phi_Newdmf",200,-5,5,0,400);
  hPUcorrPtSum_phi_Newdmf = fs->make<TProfile>(("hPUcorrPtSum_phi_Newdmf"+prefix).c_str(),"hPUcorrPtSum_phi_Newdmf",200,-5,5,0,400);


  hNeutralIsoPtSumWeight1_vtx_Newdmf = fs->make<TProfile>(("hNeutralIsoPtSumWeight1_vtx_Newdmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight1_vtx_Newdmf",200,0,200,0,400); 
  hNeutralIsoPtSumWeight2_vtx_Newdmf = fs->make<TProfile>(("hNeutralIsoPtSumWeight2_vtx_Newdmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight2_vtx_Newdmf",200,0,200,0,400); 
  hNeutralIsoPtSumWeight1NQ_vtx_Newdmf = fs->make<TProfile>(("hNeutralIsoPtSumWeight1NQ_vtx_Newdmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight1NQ_vtx_Newdmf",200,0,200,0,400); 
  hNeutralIsoPtSumWeight2NQ_vtx_Newdmf = fs->make<TProfile>(("hNeutralIsoPtSumWeight2NQ_vtx_Newdmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight2NQ_vtx_Newdmf",200,0,200,0,400); 
  hNeutralHadronIsoPtSum_vtx_Newdmf  = fs->make<TProfile>(("hNeutralHadronIsoPtSum_vtx_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSum_vtx_Newdmf",200,0,200,0,400);
  hNeutralHadronIsoPtSumWeight1_vtx_Newdmf = fs->make<TProfile>(("hNeutralHadronIsoPtSumWeight1_vtx_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight1_vtx_Newdmf",200,0,200,0,400);
  hNeutralHadronIsoPtSumWeight2_vtx_Newdmf = fs->make<TProfile>(("hNeutralHadronIsoPtSumWeight2_vtx_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight2_vtx_Newdmf",200,0,200,0,400);
  hNeutralHadronIsoPtSumWeight1NQ_vtx_Newdmf = fs->make<TProfile>(("hNeutralHadronIsoPtSumWeight1NQ_vtx_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight1NQ_vtx_Newdmf",200,0,200,0,400);
  hNeutralHadronIsoPtSumWeight2NQ_vtx_Newdmf = fs->make<TProfile>(("hNeutralHadronIsoPtSumWeight2NQ_vtx_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight2NQ_vtx_Newdmf",200,0,200,0,400);
  hChargedIsoPtSum_vtx_Newdmf  = fs->make<TProfile>(("hChargedIsoPtSum_vtx_Newdmf"+prefix).c_str(),"hChargedIsoPtSum_vtx_Newdmf",200,0,200,0,400); 
  hNeutralIsoPtSum_vtx_Newdmf = fs->make<TProfile>(("hNeutralIsoPtSum_vtx_Newdmf"+prefix).c_str(),"hNeutralIsoPtSum_vtx_Newdmf",200,0,200,0,400);
  hPUcorrPtSum_vtx_Newdmf = fs->make<TProfile>(("hPUcorrPtSum_vtx_Newdmf"+prefix).c_str(),"hPUcorrPtSum_vtx_Newdmf",200,0,200,0,400);

  hNeutralIsoPtSumWeight1_nGoodVtx_Newdmf = fs->make<TProfile>(("hNeutralIsoPtSumWeight1_nGoodVtx_Newdmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight1_nGoodVtx_Newdmf",200,0,200,0,400); 
  hNeutralIsoPtSumWeight2_nGoodVtx_Newdmf = fs->make<TProfile>(("hNeutralIsoPtSumWeight2_nGoodVtx_Newdmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight2_nGoodVtx_Newdmf",200,0,200,0,400); 
  hNeutralIsoPtSumWeight1NQ_nGoodVtx_Newdmf = fs->make<TProfile>(("hNeutralIsoPtSumWeight1NQ_nGoodVtx_Newdmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight1NQ_nGoodVtx_Newdmf",200,0,200,0,400); 
  hNeutralIsoPtSumWeight2NQ_nGoodVtx_Newdmf = fs->make<TProfile>(("hNeutralIsoPtSumWeight2NQ_nGoodVtx_Newdmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight2NQ_nGoodVtx_Newdmf",200,0,200,0,400); 
  hNeutralHadronIsoPtSum_nGoodVtx_Newdmf  = fs->make<TProfile>(("hNeutralHadronIsoPtSum_nGoodVtx_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSum_nGoodVtx_Newdmf",200,0,200,0,400);
  hNeutralHadronIsoPtSumWeight1_nGoodVtx_Newdmf = fs->make<TProfile>(("hNeutralHadronIsoPtSumWeight1_nGoodVtx_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight1_nGoodVtx_Newdmf",200,0,200,0,400);
  hNeutralHadronIsoPtSumWeight2_nGoodVtx_Newdmf = fs->make<TProfile>(("hNeutralHadronIsoPtSumWeight2_nGoodVtx_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight2_nGoodVtx_Newdmf",200,0,200,0,400);
  hNeutralHadronIsoPtSumWeight1NQ_nGoodVtx_Newdmf = fs->make<TProfile>(("hNeutralHadronIsoPtSumWeight1NQ_nGoodVtx_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight1NQ_nGoodVtx_Newdmf",200,0,200,0,400);
  hNeutralHadronIsoPtSumWeight2NQ_nGoodVtx_Newdmf = fs->make<TProfile>(("hNeutralHadronIsoPtSumWeight2NQ_nGoodVtx_Newdmf"+prefix).c_str() ,"hNeutralHadronIsoPtSumWeight2NQ_nGoodVtx_Newdmf",200,0,200,0,400);
  hChargedIsoPtSum_nGoodVtx_Newdmf  = fs->make<TProfile>(("hChargedIsoPtSum_nGoodVtx_Newdmf"+prefix).c_str(),"hChargedIsoPtSum_nGoodVtx_Newdmf",200,0,200,0,400); 
  hNeutralIsoPtSum_nGoodVtx_Newdmf = fs->make<TProfile>(("hNeutralIsoPtSum_nGoodVtx_Newdmf"+prefix).c_str(),"hNeutralIsoPtSum_nGoodVtx_Newdmf",200,0,200,0,400);
  hPUcorrPtSum_nGoodVtx_Newdmf = fs->make<TProfile>(("hPUcorrPtSum_nGoodVtx_Newdmf"+prefix).c_str(),"hPUcorrPtSum_nGoodVtx_Newdmf",200,0,200,0,400);


  GenTauPiZeroCandidatesNewDMF = fs->make<TH1F>(("GenTauPiZeroCandidatesNewDMF"+prefix).c_str() ,"GenTauPiZeroCandidatesNewDMF",15,0,15); 
  GenTauHadronCandidatesNewDMF  = fs->make<TH1F>(("GenTauHadronCandidatesNewDMF"+prefix).c_str() ,"GenTauHadronCandidatesNewDMF",15,0,15);
...
GenTauPiZeroCandidatesDMF = fs->make<TH1F>(("GenTauPiZeroCandidatesDMF"+prefix).c_str() ,"GenTauPiZeroCandidatesDMF",15,0,15); 
  ...
  hFillDecayModeNewDM  = fs->make<TH1F>(("hFillDecayModeNewDM"+prefix).c_str() ,"hFillDecayModeNewDM",15,0,15);
...
void NewDefinitions::Fill(const edm::Event& iEvent) {
   using namespace edm;
   using namespace std;
...
////////////////////////// individual decay modes
 ...
 bool DecayModeFindingNew = false;    
 ...
 if((*_Newdmf)[tauCandidate] > 0.5) DecayModeFindingNew = true;

if( (RecoptCut && TauEtaCuts ) ) {

if(DecayModeFinding) {

    GenTauPt_DM1Prong->Fill(gentaujet->pt());
    GenTauEta_DM1Prong->Fill(gentaujet->eta());
    GenTauPhi_DM1Prong->Fill(gentaujet->phi());

    if(gentaujet->pt() != 0) {
       TauPtResponse_DM1Prong->Fill(tauCandidate->pt()/gentaujet->pt());
    }
  ...
  if((*_hpsTau1)[tauCandidate] > 0.5) {
     ...
     if(gentaujet->pt() != 0) {
       TauPtResponse_DM1ProngLChar->Fill(tauCandidate->pt()/gentaujet->pt());
    }
} 
}

if(DecayModeFindingNew) {
...
} /// tau decay mode conditions complete here
...
if(DecayModeFinding) {
    ...
    GenTauPt_DM1Prong1pi0->Fill(gentaujet->pt());
    GenTauEta_DM1Prong1pi0->Fill(gentaujet->eta());
    GenTauPhi_DM1Prong1pi0->Fill(gentaujet->phi());


     if(gentaujet->pt() != 0) {
       TauPtResponse_DM1Prong1pi0->Fill(tauCandidate->pt()/gentaujet->pt());
    }
  ...
  if((*_hpsTau1)[tauCandidate] > 0.5) {
     ...
     if(gentaujet->pt() != 0) {
       TauPtResponse_DM1Prong1pi0LChar->Fill(tauCandidate->pt()/gentaujet->pt());
    }
} 
...
if(DecayModeFinding) {
    ...
    GenTauPt_DM1Prong2pi0->Fill(gentaujet->pt());
    GenTauEta_DM1Prong2pi0->Fill(gentaujet->eta());
    GenTauPhi_DM1Prong2pi0->Fill(gentaujet->phi());

    if(gentaujet->pt() != 0) {
       TauPtResponse_DM1Prong2pi0->Fill(tauCandidate->pt()/gentaujet->pt());
    }
  ...
  if((*_hpsTau1)[tauCandidate] > 0.5) {
     ...
     if(gentaujet->pt() != 0) {
       TauPtResponse_DM1Prong2pi0LChar->Fill(tauCandidate->pt()/gentaujet->pt());
    }
} 
...
if(DecayModeFinding) {
    ...
    GenTauPt_DM3Prong->Fill(gentaujet->pt());
    GenTauEta_DM3Prong->Fill(gentaujet->eta());
    GenTauPhi_DM3Prong->Fill(gentaujet->phi());

      if(gentaujet->pt() != 0) {
       TauPtResponse_DM3Prong->Fill(tauCandidate->pt()/gentaujet->pt());
    }
  ...
  if((*_hpsTau1)[tauCandidate] > 0.5) {
     ...
     if(gentaujet->pt() != 0) {
       TauPtResponse_DM3ProngLChar->Fill(tauCandidate->pt()/gentaujet->pt());
    }
} 
...
if(DecayModeFindingNew) {
  ...
  if((*_hpsTau1)[tauCandidate] > 0.5) {
     ...
     if(gentaujet->pt() != 0) {
       TauPtResponse_NDM3ProngLChar->Fill(tauCandidate->pt()/gentaujet->pt());
    }
} 
...
if(DecayModeFinding) {
    ...
    GenTauPt_DM3Prong1pi0->Fill(gentaujet->pt());
    GenTauEta_DM3Prong1pi0->Fill(gentaujet->eta());
    GenTauPhi_DM3Prong1pi0->Fill(gentaujet->phi());


       if(gentaujet->pt() != 0) {
       TauPtResponse_DM3Prong1pi0->Fill(tauCandidate->pt()/gentaujet->pt());
    }
  ...
  if((*_hpsTau1)[tauCandidate] > 0.5) {
     ...
     if(gentaujet->pt() != 0) {
       TauPtResponse_DM3Prong1pi0LChar->Fill(tauCandidate->pt()/gentaujet->pt());
    }
} 
...
/**********************************  Start New **************************************/
    ...
    if(DecayModeFindingNew) { 
     ...
     if((tauCandidate->leadPFChargedHadrCand().isNonnull()) && (tauCandidate->leadPFChargedHadrCand()->p() > 0)) {                                                  
          FillHOverP_NewDMF->Fill(tauCandidate->leadPFChargedHadrCand()->hcalEnergy()/tauCandidate->leadPFChargedHadrCand()->p());
          FillEOverP_NewDMF->Fill(tauCandidate->leadPFChargedHadrCand()->ecalEnergy()/tauCandidate->leadPFChargedHadrCand()->p());

         }

         hFillTauHcal3x3OverPLead_NewDMF->Fill(tauCandidate->hcal3x3OverPLead());

          // photon fraction
            int sumPt2 = 0;
           for ( std::vector<PFCandidatePtr>::const_iterator signalTrack =  tauCandidate->signalPFGammaCands().begin() ;signalTrack != tauCandidate->signalPFGammaCands().end(); ++signalTrack ) {
                   sumPt2 += (*signalTrack)->pt();

             }
        
             if(tauCandidate->pt() > 0 ){ FillGammaFraction_NewDMF->Fill(sumPt2/tauCandidate->pt()); }


     GenTauPtWithNewDMF->Fill(gentaujet->pt());
     GenTauEtaWithNewDMF->Fill(gentaujet->eta());
     GenTauPhiWithNewDMF->Fill(gentaujet->phi());

     GenTauPiZeroCandidatesNewDMF->Fill(tauCandidate->signalPiZeroCandidates().size());
     GenTauHadronCandidatesNewDMF->Fill(tauCandidate->signalTauChargedHadronCandidates().size());

     int calculateDecayModeNew = -999;

     if((tauCandidate->signalTauChargedHadronCandidates().size() == 1) && (tauCandidate->signalPiZeroCandidates().size() == 0)) {calculateDecayModeNew =0 ;}
     if((tauCandidate->signalTauChargedHadronCandidates().size() == 1) && (tauCandidate->signalPiZeroCandidates().size() == 1)) {calculateDecayModeNew =1 ;}
  
     if((tauCandidate->signalTauChargedHadronCandidates().size() == 1) && (tauCandidate->signalPiZeroCandidates().size() == 2)) {calculateDecayModeNew =2;}

    if((tauCandidate->signalTauChargedHadronCandidates().size() == 2) && (tauCandidate->signalPiZeroCandidates().size() == 0)) {calculateDecayModeNew =3;}
           
    if((tauCandidate->signalTauChargedHadronCandidates().size() == 2) && (tauCandidate->signalPiZeroCandidates().size() == 1)) {calculateDecayModeNew =4;}

   if((tauCandidate->signalTauChargedHadronCandidates().size() == 2) && (tauCandidate->signalPiZeroCandidates().size() == 2)) {calculateDecayModeNew =5;}

  if((tauCandidate->signalTauChargedHadronCandidates().size() == 3) && (tauCandidate->signalPiZeroCandidates().size() == 0)) {calculateDecayModeNew =6;}

  if((tauCandidate->signalTauChargedHadronCandidates().size() == 3) && (tauCandidate->signalPiZeroCandidates().size() == 1)) {calculateDecayModeNew =7;}

   if((tauCandidate->signalTauChargedHadronCandidates().size() == 3) && (tauCandidate->signalPiZeroCandidates().size() == 2)) {calculateDecayModeNew =8;}

    if((tauCandidate->signalTauChargedHadronCandidates().size() == 4) && (tauCandidate->signalPiZeroCandidates().size() == 0)) {calculateDecayModeNew =9;}

 if((tauCandidate->signalTauChargedHadronCandidates().size() == 4) && (tauCandidate->signalPiZeroCandidates().size() == 1)) {calculateDecayModeNew =10;}

 if((tauCandidate->signalTauChargedHadronCandidates().size() == 4) && (tauCandidate->signalPiZeroCandidates().size() == 2)) {calculateDecayModeNew =11;}

   if((tauCandidate->signalTauChargedHadronCandidates().size() == 5) && (tauCandidate->signalPiZeroCandidates().size() == 0)) {calculateDecayModeNew =12;}

 if((tauCandidate->signalTauChargedHadronCandidates().size() == 5) && (tauCandidate->signalPiZeroCandidates().size() == 1)) {calculateDecayModeNew =13;}

   if( (tauCandidate->signalTauChargedHadronCandidates().size() == 5) && (tauCandidate->signalPiZeroCandidates().size() == 2)) {calculateDecayModeNew =14;}

   if(tauCandidate->signalTauChargedHadronCandidates().size() >= 6) {calculateDecayModeNew =15;}

  hFillDecayModeNewDM->Fill(calculateDecayModeNew);

	hNeutralIsoPtSumWeight1_Newdmf->Fill((*_nw1)[tauCandidate] );
	hNeutralIsoPtSumWeight2_Newdmf->Fill((*_nw2)[tauCandidate] );
	hNeutralIsoPtSumWeight1NQ_Newdmf->Fill((*_nw1nq)[tauCandidate] ); 
	hNeutralIsoPtSumWeight2NQ_Newdmf->Fill((*_nw2nq)[tauCandidate] );
	hNeutralHadronIsoPtSum_Newdmf->Fill((*_h1)[tauCandidate] );
	hNeutralHadronIsoPtSumWeight1_Newdmf->Fill((*_hw1)[tauCandidate] ); 
	hNeutralHadronIsoPtSumWeight2_Newdmf->Fill((*_hw2)[tauCandidate] );
	hNeutralHadronIsoPtSumWeight1NQ_Newdmf->Fill((*_hw1nq)[tauCandidate] );
	hNeutralHadronIsoPtSumWeight2NQ_Newdmf->Fill((*_hw2nq)[tauCandidate] );
	hChargedIsoPtSum_Newdmf->Fill((*_rawc)[tauCandidate] );
	hNeutralIsoPtSum_Newdmf->Fill((*_rawn)[tauCandidate] );
	hPUcorrPtSum_Newdmf->Fill((*_rawpu)[tauCandidate] );
	
	hNeutralIsoPtSumWeight1_pt_Newdmf->Fill(gentaujet->pt(),(*_nw1)[tauCandidate] );
	hNeutralIsoPtSumWeight2_pt_Newdmf->Fill(gentaujet->pt(),(*_nw2)[tauCandidate] );
	hNeutralIsoPtSumWeight1NQ_pt_Newdmf->Fill(gentaujet->pt(),(*_nw1nq)[tauCandidate] );
	hNeutralIsoPtSumWeight2NQ_pt_Newdmf->Fill(gentaujet->pt(),(*_nw2nq)[tauCandidate] );
	hNeutralHadronIsoPtSum_pt_Newdmf->Fill(gentaujet->pt(),(*_h1)[tauCandidate] );
	hNeutralHadronIsoPtSumWeight1_pt_Newdmf->Fill(gentaujet->pt(),(*_hw1)[tauCandidate] );
	hNeutralHadronIsoPtSumWeight2_pt_Newdmf->Fill(gentaujet->pt(),(*_hw2)[tauCandidate] );
	hNeutralHadronIsoPtSumWeight1NQ_pt_Newdmf->Fill(gentaujet->pt(),(*_hw1nq)[tauCandidate] );
	hNeutralHadronIsoPtSumWeight2NQ_pt_Newdmf->Fill(gentaujet->pt(),(*_hw2nq)[tauCandidate] );
	hChargedIsoPtSum_pt_Newdmf->Fill(gentaujet->pt(),(*_rawc)[tauCandidate] );
	hNeutralIsoPtSum_pt_Newdmf->Fill(gentaujet->pt(),(*_rawn)[tauCandidate] );
	hPUcorrPtSum_pt_Newdmf->Fill(gentaujet->pt(),(*_rawpu)[tauCandidate] );
	

	hNeutralIsoPtSumWeight1_eta_Newdmf->Fill(gentaujet->eta(),(*_nw1)[tauCandidate] );
	hNeutralIsoPtSumWeight2_eta_Newdmf->Fill(gentaujet->eta(),(*_nw2)[tauCandidate] );
	hNeutralIsoPtSumWeight1NQ_eta_Newdmf->Fill(gentaujet->eta(),(*_nw1nq)[tauCandidate] );
	hNeutralIsoPtSumWeight2NQ_eta_Newdmf->Fill(gentaujet->eta(),(*_nw2nq)[tauCandidate] );
	hNeutralHadronIsoPtSum_eta_Newdmf->Fill(gentaujet->eta(),(*_h1)[tauCandidate] );
	hNeutralHadronIsoPtSumWeight1_eta_Newdmf->Fill(gentaujet->eta(),(*_hw1)[tauCandidate] );
	hNeutralHadronIsoPtSumWeight2_eta_Newdmf->Fill(gentaujet->eta(),(*_hw2)[tauCandidate] );
	hNeutralHadronIsoPtSumWeight1NQ_eta_Newdmf->Fill(gentaujet->eta(),(*_hw1nq)[tauCandidate] );
	hNeutralHadronIsoPtSumWeight2NQ_eta_Newdmf->Fill(gentaujet->eta(),(*_hw2nq)[tauCandidate] );
	hChargedIsoPtSum_eta_Newdmf->Fill(gentaujet->eta(),(*_rawc)[tauCandidate] );
	hNeutralIsoPtSum_eta_Newdmf->Fill(gentaujet->eta(),(*_rawn)[tauCandidate] );
	hPUcorrPtSum_eta_Newdmf->Fill(gentaujet->eta(),(*_rawpu)[tauCandidate] );
	


	hNeutralIsoPtSumWeight1_phi_Newdmf->Fill(gentaujet->phi(),(*_nw1)[tauCandidate] );
	hNeutralIsoPtSumWeight2_phi_Newdmf->Fill(gentaujet->phi(),(*_nw2)[tauCandidate] );
	hNeutralIsoPtSumWeight1NQ_phi_Newdmf->Fill(gentaujet->phi(),(*_nw1nq)[tauCandidate] );
	hNeutralIsoPtSumWeight2NQ_phi_Newdmf->Fill(gentaujet->phi(),(*_nw2nq)[tauCandidate] );
	hNeutralHadronIsoPtSum_phi_Newdmf->Fill(gentaujet->phi(),(*_h1)[tauCandidate] );
	hNeutralHadronIsoPtSumWeight1_phi_Newdmf->Fill(gentaujet->phi(),(*_hw1)[tauCandidate] );
	hNeutralHadronIsoPtSumWeight2_phi_Newdmf->Fill(gentaujet->phi(),(*_hw2)[tauCandidate] );
	hNeutralHadronIsoPtSumWeight1NQ_phi_Newdmf->Fill(gentaujet->phi(),(*_hw1nq)[tauCandidate] );
	hNeutralHadronIsoPtSumWeight2NQ_phi_Newdmf->Fill(gentaujet->phi(),(*_hw2nq)[tauCandidate] );
	hChargedIsoPtSum_phi_Newdmf->Fill(gentaujet->phi(),(*_rawc)[tauCandidate] );
	hNeutralIsoPtSum_phi_Newdmf->Fill(gentaujet->phi(),(*_rawn)[tauCandidate] );
	hPUcorrPtSum_phi_Newdmf->Fill(gentaujet->phi(),(*_rawpu)[tauCandidate] );
	
	

	hNeutralIsoPtSumWeight1_vtx_Newdmf->Fill(vtx->size(),(*_nw1)[tauCandidate] );
	hNeutralIsoPtSumWeight2_vtx_Newdmf->Fill(vtx->size(),(*_nw2)[tauCandidate] );
	hNeutralIsoPtSumWeight1NQ_vtx_Newdmf->Fill(vtx->size(),(*_nw1nq)[tauCandidate] );
	hNeutralIsoPtSumWeight2NQ_vtx_Newdmf->Fill(vtx->size(),(*_nw2nq)[tauCandidate] );
	hNeutralHadronIsoPtSum_vtx_Newdmf->Fill(vtx->size(),(*_h1)[tauCandidate] );
	hNeutralHadronIsoPtSumWeight1_vtx_Newdmf->Fill(vtx->size(),(*_hw1)[tauCandidate] );
	hNeutralHadronIsoPtSumWeight2_vtx_Newdmf->Fill(vtx->size(),(*_hw2)[tauCandidate] );
	hNeutralHadronIsoPtSumWeight1NQ_vtx_Newdmf->Fill(vtx->size(),(*_hw1nq)[tauCandidate] );
	hNeutralHadronIsoPtSumWeight2NQ_vtx_Newdmf->Fill(vtx->size(),(*_hw2nq)[tauCandidate] );
	hChargedIsoPtSum_vtx_Newdmf->Fill(vtx->size(),(*_rawc)[tauCandidate] );
	hNeutralIsoPtSum_vtx_Newdmf->Fill(vtx->size(),(*_rawn)[tauCandidate] );
	hPUcorrPtSum_vtx_Newdmf->Fill(vtx->size(),(*_rawpu)[tauCandidate] );

	hNeutralIsoPtSumWeight1_nGoodVtx_Newdmf->Fill(nGoodVtx,(*_nw1)[tauCandidate] );
	hNeutralIsoPtSumWeight2_nGoodVtx_Newdmf->Fill(nGoodVtx,(*_nw2)[tauCandidate] );
	hNeutralIsoPtSumWeight1NQ_nGoodVtx_Newdmf->Fill(nGoodVtx,(*_nw1nq)[tauCandidate] );
	hNeutralIsoPtSumWeight2NQ_nGoodVtx_Newdmf->Fill(nGoodVtx,(*_nw2nq)[tauCandidate] );
	hNeutralHadronIsoPtSum_nGoodVtx_Newdmf->Fill(nGoodVtx,(*_h1)[tauCandidate] );
	hNeutralHadronIsoPtSumWeight1_nGoodVtx_Newdmf->Fill(nGoodVtx,(*_hw1)[tauCandidate] );
	hNeutralHadronIsoPtSumWeight2_nGoodVtx_Newdmf->Fill(nGoodVtx,(*_hw2)[tauCandidate] );
	hNeutralHadronIsoPtSumWeight1NQ_nGoodVtx_Newdmf->Fill(nGoodVtx,(*_hw1nq)[tauCandidate] );
	hNeutralHadronIsoPtSumWeight2NQ_nGoodVtx_Newdmf->Fill(nGoodVtx,(*_hw2nq)[tauCandidate] );
	hChargedIsoPtSum_nGoodVtx_Newdmf->Fill(nGoodVtx,(*_rawc)[tauCandidate] );
	hNeutralIsoPtSum_nGoodVtx_Newdmf->Fill(nGoodVtx,(*_rawn)[tauCandidate] );
	hPUcorrPtSum_nGoodVtx_Newdmf->Fill(nGoodVtx,(*_rawpu)[tauCandidate] );
   ...
   // old dmf 
	   if(DecayModeFinding) {
         ...
         hFillTauHcal3x3OverPLead_DMF->Fill(tauCandidate->hcal3x3OverPLead());
          ...
          // photon fraction
           ...
           for ( std::vector<PFCandidatePtr>::const_iterator signalTrack =  tauCandidate->signalPFGammaCands().begin() ;signalTrack != tauCandidate->signalPFGammaCands().end(); ++signalTrack ) {
                   sumPt3 += (*signalTrack)->pt();

             }
        
 
             if(tauCandidate->pt() > 0 ){ FillGammaFraction_DMF->Fill(sumPt3/tauCandidate->pt()); }
      ...
      int calculateDecayMode = -999;

     if((tauCandidate->signalTauChargedHadronCandidates().size() == 1) && (tauCandidate->signalPiZeroCandidates().size() == 0)) {calculateDecayMode =0 ;}
     if((tauCandidate->signalTauChargedHadronCandidates().size() == 1) && (tauCandidate->signalPiZeroCandidates().size() == 1)) {calculateDecayMode =1 ;}
  
     if((tauCandidate->signalTauChargedHadronCandidates().size() == 1) && (tauCandidate->signalPiZeroCandidates().size() == 2)) {calculateDecayMode =2;}

    if((tauCandidate->signalTauChargedHadronCandidates().size() == 2) && (tauCandidate->signalPiZeroCandidates().size() == 0)) {calculateDecayMode =3;}
           
    if((tauCandidate->signalTauChargedHadronCandidates().size() == 2) && (tauCandidate->signalPiZeroCandidates().size() == 1)) {calculateDecayMode =4;}

   if((tauCandidate->signalTauChargedHadronCandidates().size() == 2) && (tauCandidate->signalPiZeroCandidates().size() == 2)) {calculateDecayMode =5;}

  if((tauCandidate->signalTauChargedHadronCandidates().size() == 3) && (tauCandidate->signalPiZeroCandidates().size() == 0)) {calculateDecayMode =6;}

  if((tauCandidate->signalTauChargedHadronCandidates().size() == 3) && (tauCandidate->signalPiZeroCandidates().size() == 1)) {calculateDecayMode =7;}

   if((tauCandidate->signalTauChargedHadronCandidates().size() == 3) && (tauCandidate->signalPiZeroCandidates().size() == 2)) {calculateDecayMode =8;}

    if((tauCandidate->signalTauChargedHadronCandidates().size() == 4) && (tauCandidate->signalPiZeroCandidates().size() == 0)) {calculateDecayMode =9;}
	
 if((tauCandidate->signalTauChargedHadronCandidates().size() == 4) && (tauCandidate->signalPiZeroCandidates().size() == 1)) {calculateDecayMode =10;}

 if((tauCandidate->signalTauChargedHadronCandidates().size() == 4) && (tauCandidate->signalPiZeroCandidates().size() == 2)) {calculateDecayMode =11;}

   if((tauCandidate->signalTauChargedHadronCandidates().size() == 5) && (tauCandidate->signalPiZeroCandidates().size() == 0)) {calculateDecayMode =12;}

 if((tauCandidate->signalTauChargedHadronCandidates().size() == 5) && (tauCandidate->signalPiZeroCandidates().size() == 1)) {calculateDecayMode =13;}

   if( (tauCandidate->signalTauChargedHadronCandidates().size() == 5) && (tauCandidate->signalPiZeroCandidates().size() == 2)) {calculateDecayMode =14;}

   if(tauCandidate->signalTauChargedHadronCandidates().size() >= 6) {calculateDecayMode =15;}

  hFillDecayMode->Fill(calculateDecayMode);
...
bool NewDefinitions::OverlapWithGenTau(double Taueta , double Tauphi ,edm::Handle<reco::PFTauCollection> _hpsTaucoll ,int  &index     ) {
...
bool NewDefinitions::IsZTauTau(edm::Handle<reco::GenParticleCollection> genParticles){
   bool isZTauTau = false;
