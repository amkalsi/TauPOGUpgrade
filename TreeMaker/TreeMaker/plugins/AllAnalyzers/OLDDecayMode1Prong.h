#ifndef __DECAYMODE_NEW_OLDD_H_                                                                                                                                          
#define __DECAYMODE_NEW_OLDD_H_ 
...
class OLDDecayMode1Prong {
    public:
        OLDDecayMode1Prong(std::string prefix,edm::Service<TFileService> fs, const edm::ParameterSet& cfg);
      ~OLDDecayMode1Prong();
