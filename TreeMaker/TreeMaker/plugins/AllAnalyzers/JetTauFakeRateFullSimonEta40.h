#ifndef __JET_S_FAKERATE_4P0FULL_H_              
#define __JET_S_FAKERATE_4P0FULL_H_ 
...
class JetTauFakeRateFullSimonEta40 {
    public:
        JetTauFakeRateFullSimonEta40(std::string prefix, edm::Service<TFileService> fs, const edm::ParameterSet& cfg);
      ~JetTauFakeRateFullSimonEta40();
