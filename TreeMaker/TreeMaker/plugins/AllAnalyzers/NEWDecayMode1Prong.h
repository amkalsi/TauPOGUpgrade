#ifndef __DECAYMODE_OLD_OLDD_H_                                                                                                                                          
#define __DECAYMODE_OLD_OLDD_H_ 
...
class NEWDecayMode1Prong {
    public:
        NEWDecayMode1Prong(std::string prefix,edm::Service<TFileService> fs, const edm::ParameterSet& cfg);
      ~NEWDecayMode1Prong();
