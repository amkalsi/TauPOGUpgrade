#ifndef __DEFINITION_CHECK_ETAU3p0_H_                                                                                                                                          
#define __DEFINITION_CHECK_ETAU3p0_H_ 
...
class NewDefinitionU3p0 {
    public:
        NewDefinitionU3p0(std::string prefix,edm::Service<TFileService> fs, const edm::ParameterSet& cfg);
      ~NewDefinitionU3p0();
