...
OldDecayMode::OldDecayMode(std::string prefix,edm::Service<TFileService> fs,const edm::ParameterSet& iConfig)
{
...
void OldDecayMode::Fill(const edm::Event& iEvent) {
   using namespace edm;
   using namespace std;
...
bool OldDecayMode::OverlapWithGenTau(double Taueta , double Tauphi ,edm::Handle<reco::PFTauCollection> _hpsTaucoll ,int  &index     ) {
...
bool OldDecayMode::IsZTauTau(edm::Handle<reco::GenParticleCollection> genParticles){
   bool isZTauTau = false;
