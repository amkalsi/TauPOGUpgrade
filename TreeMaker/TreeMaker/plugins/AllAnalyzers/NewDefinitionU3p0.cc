...
NewDefinitionU3p0::NewDefinitionU3p0(std::string prefix,edm::Service<TFileService> fs,const edm::ParameterSet& iConfig)
 {
...
NewDefinitionU3p0::~NewDefinitionU3p0()
{
...
void NewDefinitionU3p0::Fill(const edm::Event& iEvent) {
   using namespace edm;
   using namespace std;
...
////////////////////////// individual decay modes
   ...
   for(reco::GenJetCollection::const_iterator gentaujet = genTauJets->begin(); gentaujet !=  genTauJets->end(); ++gentaujet) { 
        ...
        if(fabs(gentaujet->eta()) >= 3.0) continue;
...
bool NewDefinitionU3p0::OverlapWithGenTau(double Taueta , double Tauphi ,edm::Handle<reco::PFTauCollection> _hpsTaucoll ,int  &index     ) {
...
bool NewDefinitionU3p0::IsZTauTau(edm::Handle<reco::GenParticleCollection> genParticles){
   bool isZTauTau = false;
