...
OLDDecayMode1Prong::OLDDecayMode1Prong(std::string prefix,edm::Service<TFileService> fs,const edm::ParameterSet& iConfig)
{
...
OLDDecayMode1Prong::~OLDDecayMode1Prong()
{
...
void OLDDecayMode1Prong::Fill(const edm::Event& iEvent) {
   using namespace edm;
   using namespace std;
...
bool OLDDecayMode1Prong::OverlapWithGenTau(double Taueta , double Tauphi , edm::Handle<reco::PFTauCollection> taujetcol, edm::Handle<reco::PFTauDiscriminator>  disc, int &index ) {
...
bool OLDDecayMode1Prong::OverlapWithGenTauForOther(double Taueta , double Tauphi , edm::Handle<reco::PFTauCollection> taujetcol, edm::Handle<reco::PFTauDiscriminator>  disc, edm::Handle<reco::PFTauDiscriminator>  disc1 ,int &index ) {
   double drtmp = _TauToGenMatchingDeltaR;
   bool genTaufound = false;
   index = -1;
   for ( unsigned iTau = 0; iTau < taujetcol->size(); ++iTau ) {
...
bool OLDDecayMode1Prong::IsZTauTau(edm::Handle<reco::GenParticleCollection> genParticles){
   bool isZTauTau = false;
