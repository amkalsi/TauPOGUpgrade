#ifndef __MUON_FAKERATE_N_H_                                                                                                                                          
#define __MUON_FAKERATE_N_H_ 
...
class MuTauFakeRateNew {
    public:
        MuTauFakeRateNew(std::string prefix, edm::Service<TFileService> fs, const edm::ParameterSet& cfg);
      ~MuTauFakeRateNew();
