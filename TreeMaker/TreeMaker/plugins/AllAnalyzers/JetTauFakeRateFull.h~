#ifndef __JET_FAKERATE_FULL_H_                                                                                                                                          
#define __JET_FAKERATE_FULL_H_ 
...
class JetTauFakeRateFull {
    public:
        JetTauFakeRateFull(std::string prefix, edm::Service<TFileService> fs, const edm::ParameterSet& cfg);
      ~JetTauFakeRateFull();
