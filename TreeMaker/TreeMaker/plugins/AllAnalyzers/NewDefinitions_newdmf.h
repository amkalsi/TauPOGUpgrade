#ifndef __DEFINITION_CHECK_NEW_H_                                                                                                                                          
#define __DEFINITION_CHECK_NEW_H_ 
...
class NewDefinitions_newdmf {
    public:
        NewDefinitions_newdmf(std::string prefix,edm::Service<TFileService> fs, const edm::ParameterSet& cfg);
      ~NewDefinitions_newdmf();
