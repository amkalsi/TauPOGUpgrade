#ifndef __JET_S_FAKERATE_23FULL_H_              
#define __JET_S_FAKERATE_23FULL_H_ 
...
class JetTauFakeRateFullSimonEtaG23 {
    public:
        JetTauFakeRateFullSimonEtaG23(std::string prefix, edm::Service<TFileService> fs, const edm::ParameterSet& cfg);
      ~JetTauFakeRateFullSimonEtaG23();
