...
NewDefinitionG2p3::NewDefinitionG2p3(std::string prefix,edm::Service<TFileService> fs,const edm::ParameterSet& iConfig)
 {
...
NewDefinitionG2p3::~NewDefinitionG2p3()
{
...
void NewDefinitionG2p3::Fill(const edm::Event& iEvent) {
   using namespace edm;
   using namespace std;
...
bool NewDefinitionG2p3::OverlapWithGenTau(double Taueta , double Tauphi ,edm::Handle<reco::PFTauCollection> _hpsTaucoll ,int  &index     ) {
...
bool NewDefinitionG2p3::IsZTauTau(edm::Handle<reco::GenParticleCollection> genParticles){
   bool isZTauTau = false;
