...
MuTauFakeRateG2p3::MuTauFakeRateG2p3(std::string prefix,edm::Service<TFileService> fs,const edm::ParameterSet& iConfig)
{
...
MuTauFakeRateG2p3::~MuTauFakeRateG2p3()
{
...
void MuTauFakeRateG2p3::Fill(const edm::Event& iEvent) {
  using namespace edm;
  using namespace std;
...
bool MuTauFakeRateG2p3::IsZMuMu(edm::Handle<reco::GenParticleCollection> genParticles){
   bool isZMuMu = false;
...
bool MuTauFakeRateG2p3::OverlapWithGenMu(double Taueta , double Tauphi ,edm::Handle<reco::GenParticleCollection> genParticles ,int  &index ) {
