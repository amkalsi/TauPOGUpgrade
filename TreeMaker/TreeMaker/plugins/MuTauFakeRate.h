#ifndef __MUON_FAKERATE_H_                                                                                                                                          
#define __MUON_FAKERATE_H_ 
...
class MuTauFakeRate {
    public:
        MuTauFakeRate(std::string prefix, edm::Service<TFileService> fs, const edm::ParameterSet& cfg);
      ~MuTauFakeRate();
...
bool OverlapWithGenTauForOther(double Taueta , double Tauphi , edm::Handle<reco::PFTauCollection> taujetcol, edm::Handle<reco::PFTauDiscriminator>  disc ,int &index ) ;
  ...
  TH1F *h_PfTau_pT_num_E;
  TH1F *h_PfTau_Eta_num_E;
  TH1F *h_PfTau_Phi_num_E;

  TH1F *h_genMuon_pT_num_E;
  TH1F *h_genMuon_Eta_num_E;
  TH1F *h_genMuon_Phi_num_E;

  TH1F *h_PfTau_pT_num_tight_E;
  TH1F *h_PfTau_Eta_num_tight_E;
  TH1F *h_PfTau_Phi_num_tight_E;

  TH1F *h_genMuon_pT_num_tight_E;
  TH1F *h_genMuon_Eta_num_tight_E;
  TH1F *h_genMuon_Phi_num_tight_E;
  ...
  TH1F *h_genMuon_pT_numM;
  TH1F *h_genMuon_Eta_numM;
  TH1F *h_genMuon_Phi_numM;

  TH1F *h_PfTau_pT_numM_E;
  TH1F *h_PfTau_Eta_numM_E;
  TH1F *h_PfTau_Phi_numM_E;
  
  TH1F *h_genMuon_pT_numM_E;
  TH1F *h_genMuon_Eta_numM_E;
  TH1F *h_genMuon_Phi_numM_E;


  TH1F *h_PfTau_pT_num_tightM;
  TH1F *h_PfTau_Eta_num_tightM;
  TH1F *h_PfTau_Phi_num_tightM;
  
  TH1F *h_genMuon_pT_num_tightM;
  TH1F *h_genMuon_Eta_num_tightM;
  TH1F *h_genMuon_Phi_num_tightM;

  //

  TH1F *h_PfTau_pT_num_tightM_E;
  TH1F *h_PfTau_Eta_num_tightM_E;
  TH1F *h_PfTau_Phi_num_tightM_E;
  
  TH1F *h_genMuon_pT_num_tightM_E;
  TH1F *h_genMuon_Eta_num_tightM_E;
  TH1F *h_genMuon_Phi_num_tightM_E;
  ...
  TH1F *h_genMuon_pT_numT;
  TH1F *h_genMuon_Eta_numT;
  TH1F *h_genMuon_Phi_numT;


  TH1F *h_PfTau_pT_numT_E;
  TH1F *h_PfTau_Eta_numT_E;
  TH1F *h_PfTau_Phi_numT_E;
  
  TH1F *h_genMuon_pT_numT_E;
  TH1F *h_genMuon_Eta_numT_E;
  TH1F *h_genMuon_Phi_numT_E;


  TH1F *h_PfTau_pT_num_tightT;
  TH1F *h_PfTau_Eta_num_tightT;
  TH1F *h_PfTau_Phi_num_tightT;
  
  TH1F *h_genMuon_pT_num_tightT;
  TH1F *h_genMuon_Eta_num_tightT;
  TH1F *h_genMuon_Phi_num_tightT;


  TH1F *h_PfTau_pT_num_tightT_E;
  TH1F *h_PfTau_Eta_num_tightT_E;
  TH1F *h_PfTau_Phi_num_tightT_E;
  
  TH1F *h_genMuon_pT_num_tightT_E;
  TH1F *h_genMuon_Eta_num_tightT_E;
  TH1F *h_genMuon_Phi_num_tightT_E;
 ...
 TH1F *Nvtx_den;
  ...
  TH1F *Nvtx_num_tight_E;
  TH1F *NGood_num_tight_E;

  //
  TH1F *Nvtx_numM;
  TH1F *NGood_numM;
  
  TH1F *Nvtx_num_tightM;
  TH1F *NGood_num_tightM;

  TH1F *Nvtx_numM_E;
  TH1F *NGood_numM_E;

  TH1F *Nvtx_num_tightM_E;
  TH1F *NGood_num_tightM_E;

  TH1F *Nvtx_numT;
  TH1F *NGood_numT;
  
  TH1F *Nvtx_num_tightT;
  TH1F *NGood_num_tightT;

  TH1F *Nvtx_numT_E;
  TH1F *NGood_numT_E;
  
  TH1F *Nvtx_num_tightT_E;
  TH1F *NGood_num_tightT_E;
