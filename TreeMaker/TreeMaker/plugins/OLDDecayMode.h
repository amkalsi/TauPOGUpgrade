#ifndef __DECAYMODE_OLDD_H_                                                                                                                                          
#define __DECAYMODE_OLDD_H_ 
...
class OLDDecayMode {
    public:
        OLDDecayMode(std::string prefix,edm::Service<TFileService> fs, const edm::ParameterSet& cfg);
      ~OLDDecayMode();
...
double PUInfo, PUInfo_Bunch0,PUInfo_true, PUInfo_true_wo;
int tauGenJetDecayModeIntfor3X3reco ;
int tauGenJetDecayModeIntfor3X3reco1;
int tauGenJetDecayModeIntfor3X3; 
...
TH1F *hFillTauHcal3x3OverPLead_DMF;                   
 ...
 TH1F *NGood_Iso2;
  ...
  //
  TH1F *TauPtResponse_CombinedL;
  TProfile *TES_CombinedL;
  TH1F *RecoTauDecayMode_CombinedL;
  TH1F *GenTauDecayMode_CombinedL;
  TH2F *reco_dm_vs_gen_CombinedL;
  TH1F *GenTauPtWithDMF_CombinedL;
  TH1F *GenTauEtaWithDMF_CombinedL;
  TH1F *GenTauPhiWithDMF_CombinedL;
  TH1F *Nvtx_CombinedL;
  TH1F *NGood_CombinedL;


  //

  TH1F *TauPtResponse_CombinedT;
  TProfile *TES_CombinedT;
  TH1F *RecoTauDecayMode_CombinedT;
  TH1F *GenTauDecayMode_CombinedT;
  TH2F *reco_dm_vs_gen_CombinedT;
  TH1F *GenTauPtWithDMF_CombinedT;
  TH1F *GenTauEtaWithDMF_CombinedT;
  TH1F *GenTauPhiWithDMF_CombinedT;
  TH1F *Nvtx_CombinedT;
  TH1F *NGood_CombinedT;
  ...
  //
  TH1F *TauPtResponse_MIsoPtSumN;
  TProfile *TES_MIsoPtSumN;
  TH1F *RecoTauDecayMode_MIsoPtSumN;
  TH1F *GenTauDecayMode_MIsoPtSumN;
  TH2F *reco_dm_vs_gen_MIsoPtSumN;
  TH1F *GenTauPtWithDMF_MIsoPtSumN;
  TH1F *GenTauEtaWithDMF_MIsoPtSumN;
  TH1F *GenTauPhiWithDMF_MIsoPtSumN;
  TH1F *Nvtx_MIsoPtSumN;
  TH1F *NGood_MIsoPtSumN;

  TH1F *TauPtResponse_LIsoPtSumN;
  TProfile *TES_LIsoPtSumN;
  TH1F *RecoTauDecayMode_LIsoPtSumN;
  TH1F *GenTauDecayMode_LIsoPtSumN;
  TH2F *reco_dm_vs_gen_LIsoPtSumN;
  TH1F *GenTauPtWithDMF_LIsoPtSumN;
  TH1F *GenTauEtaWithDMF_LIsoPtSumN;
  TH1F *GenTauPhiWithDMF_LIsoPtSumN;
  TH1F *Nvtx_LIsoPtSumN;
  TH1F *NGood_LIsoPtSumN;

  TH1F *TauPtResponse_TIsoPtSumN;
  TProfile *TES_TIsoPtSumN;
  TH1F *RecoTauDecayMode_TIsoPtSumN;
  TH1F *GenTauDecayMode_TIsoPtSumN;
  TH2F *reco_dm_vs_gen_TIsoPtSumN;
  TH1F *GenTauPtWithDMF_TIsoPtSumN;
  TH1F *GenTauEtaWithDMF_TIsoPtSumN;
  TH1F *GenTauPhiWithDMF_TIsoPtSumN;
  TH1F *Nvtx_TIsoPtSumN;
  TH1F *NGood_TIsoPtSumN;
 
  //////////////////////////////


  TH1F *TauPtResponse_MIsoPtSumN2;
  TProfile *TES_MIsoPtSumN2;
  TH1F *RecoTauDecayMode_MIsoPtSumN2;
  TH1F *GenTauDecayMode_MIsoPtSumN2;
  TH2F *reco_dm_vs_gen_MIsoPtSumN2;
  TH1F *GenTauPtWithDMF_MIsoPtSumN2;
  TH1F *GenTauEtaWithDMF_MIsoPtSumN2;
  TH1F *GenTauPhiWithDMF_MIsoPtSumN2;
  TH1F *Nvtx_MIsoPtSumN2;
  TH1F *NGood_MIsoPtSumN2;

  TH1F *TauPtResponse_LIsoPtSumN2;
  TProfile *TES_LIsoPtSumN2;
  TH1F *RecoTauDecayMode_LIsoPtSumN2;
  TH1F *GenTauDecayMode_LIsoPtSumN2;
  TH2F *reco_dm_vs_gen_LIsoPtSumN2;
  TH1F *GenTauPtWithDMF_LIsoPtSumN2;
  TH1F *GenTauEtaWithDMF_LIsoPtSumN2;
  TH1F *GenTauPhiWithDMF_LIsoPtSumN2;
  TH1F *Nvtx_LIsoPtSumN2;
  TH1F *NGood_LIsoPtSumN2;

  TH1F *TauPtResponse_TIsoPtSumN2;
  TProfile *TES_TIsoPtSumN2;
  TH1F *RecoTauDecayMode_TIsoPtSumN2;
  TH1F *GenTauDecayMode_TIsoPtSumN2;
  TH2F *reco_dm_vs_gen_TIsoPtSumN2;
  TH1F *GenTauPtWithDMF_TIsoPtSumN2;
  TH1F *GenTauEtaWithDMF_TIsoPtSumN2;
  TH1F *GenTauPhiWithDMF_TIsoPtSumN2;
  TH1F *Nvtx_TIsoPtSumN2;
  TH1F *NGood_TIsoPtSumN2;
...
// constructors and destructor
  ...
  TH2F *GenTauPtEta_ML2;
  TH2F *GenTauPtEta_MM2; 
  TH2F *GenTauPtEta_MT2; 

  TH2F *GenTauPtEta_ML3; 
  TH2F *GenTauPtEta_MT3;

  TH2F *GenTauPtEta_TIsoPtSum;
  TH2F *GenTauPtEta_MIsoPtSum; 
  TH2F *GenTauPtEta_LIsoPtSum;  

  TH2F *GenTauPtEta_TIsoPtSumN;
  TH2F *GenTauPtEta_MIsoPtSumN; 
  TH2F *GenTauPtEta_LIsoPtSumN;  

  TH2F *GenTauPtEta_TIsoPtSumN2;
  TH2F *GenTauPtEta_MIsoPtSumN2; 
  TH2F *GenTauPtEta_LIsoPtSumN2;  

  TH2F *GenTauPtEta_Den;
  TH2F *GenTauPtEta_Iso1;
  TH2F *GenTauPtEta_Iso2;
  TH2F *GenTauPtEta_Iso4 ;

  TH2F *GenTauPtEta_Combined;
  TH2F *GenTauPtEta_CombinedL;
  TH2F *GenTauPtEta_CombinedT;
  TH2F *GenTauPtEta_Cut;
  TH2F *GenTauPtEtaWithDMF;


  TH1F *N_Vtx_BX_PU_events;
  TH1F *N_Vtx_BX_true_events;
  TH1F *N_Vtx_BX0_PU_events;
  TH1F *N_Vtx_BX0_true_events;

  TH1F *N_Vtx_BX_PU_Den;
  TH1F *N_Vtx_BX_true_Den;
  TH1F *N_Vtx_BX0_PU_Den;
  TH1F *N_Vtx_BX0_true_Den;

  TH1F *N_Vtx_BX_PUWithDMF;
  TH1F *N_Vtx_BX_trueWithDMF;
  TH1F *N_Vtx_BX0_PUWithDMF;
  TH1F *N_Vtx_BX0_trueWithDMF;

  TH1F *N_Vtx_BX_PU_all;
  TH1F *N_Vtx_BX_true_all;
  TH1F *N_Vtx_BX0_PU_all;
  TH1F *N_Vtx_BX0_true_all;

  TH1F *N_Vtx_BX_PU_Iso1;
  TH1F *N_Vtx_BX_true_Iso1;
  TH1F *N_Vtx_BX0_PU_Iso1;
  TH1F *N_Vtx_BX0_true_Iso1;

  TH1F *N_Vtx_BX_PU_Iso2;
  TH1F *N_Vtx_BX_true_Iso2;
  TH1F *N_Vtx_BX0_PU_Iso2;
  TH1F *N_Vtx_BX0_true_Iso2;

  TH1F *N_Vtx_BX_PU_Iso4;
  TH1F *N_Vtx_BX_true_Iso4;
  TH1F *N_Vtx_BX0_PU_Iso4;
  TH1F *N_Vtx_BX0_true_Iso4;

  TH1F *N_Vtx_BX_PU_LIsoPtSum;
  TH1F *N_Vtx_BX_true_LIsoPtSum;
  TH1F *N_Vtx_BX0_PU_LIsoPtSum;
  TH1F *N_Vtx_BX0_true_LIsoPtSum;

  TH1F *N_Vtx_BX_PU_MIsoPtSum;
  TH1F *N_Vtx_BX_true_MIsoPtSum;
  TH1F *N_Vtx_BX0_PU_MIsoPtSum;
  TH1F *N_Vtx_BX0_true_MIsoPtSum;

  TH1F *N_Vtx_BX_PU_TIsoPtSum;
  TH1F *N_Vtx_BX_true_TIsoPtSum;
  TH1F *N_Vtx_BX0_PU_TIsoPtSum;
  TH1F *N_Vtx_BX0_true_TIsoPtSum;


  TH1F *N_Vtx_BX_PU_LIsoPtSumN;
  TH1F *N_Vtx_BX_true_LIsoPtSumN;
  TH1F *N_Vtx_BX0_PU_LIsoPtSumN;
  TH1F *N_Vtx_BX0_true_LIsoPtSumN;

  TH1F *N_Vtx_BX_PU_MIsoPtSumN;
  TH1F *N_Vtx_BX_true_MIsoPtSumN;
  TH1F *N_Vtx_BX0_PU_MIsoPtSumN;
  TH1F *N_Vtx_BX0_true_MIsoPtSumN;

  TH1F *N_Vtx_BX_PU_TIsoPtSumN;
  TH1F *N_Vtx_BX_true_TIsoPtSumN;
  TH1F *N_Vtx_BX0_PU_TIsoPtSumN;
  TH1F *N_Vtx_BX0_true_TIsoPtSumN;

  TH1F *N_Vtx_BX_PU_LIsoPtSumN2;
  TH1F *N_Vtx_BX_true_LIsoPtSumN2;
  TH1F *N_Vtx_BX0_PU_LIsoPtSumN2;
  TH1F *N_Vtx_BX0_true_LIsoPtSumN2;

  TH1F *N_Vtx_BX_PU_MIsoPtSumN2;
  TH1F *N_Vtx_BX_true_MIsoPtSumN2;
  TH1F *N_Vtx_BX0_PU_MIsoPtSumN2;
  TH1F *N_Vtx_BX0_true_MIsoPtSumN2;

  TH1F *N_Vtx_BX_PU_TIsoPtSumN2;
  TH1F *N_Vtx_BX_true_TIsoPtSumN2;
  TH1F *N_Vtx_BX0_PU_TIsoPtSumN2;
  TH1F *N_Vtx_BX0_true_TIsoPtSumN2;

  TH1F *N_Vtx_BX_PU_Combined;
  TH1F *N_Vtx_BX_true_Combined;
  TH1F *N_Vtx_BX0_PU_Combined;
  TH1F *N_Vtx_BX0_true_Combined;

  TH1F *N_Vtx_BX_PU_CombinedL;
  TH1F *N_Vtx_BX_true_CombinedL;
  TH1F *N_Vtx_BX0_PU_CombinedL;
  TH1F *N_Vtx_BX0_true_CombinedL;

  TH1F *N_Vtx_BX_PU_CombinedT;
  TH1F *N_Vtx_BX_true_CombinedT;
  TH1F *N_Vtx_BX0_PU_CombinedT;
  TH1F *N_Vtx_BX0_true_CombinedT;

  TH1F *N_Vtx_BX_PU_ML2;
  TH1F *N_Vtx_BX_true_ML2;
  TH1F *N_Vtx_BX0_PU_ML2;
  TH1F *N_Vtx_BX0_true_ML2;

  TH1F *N_Vtx_BX_PU_MM2;
  TH1F *N_Vtx_BX_true_MM2;
  TH1F *N_Vtx_BX0_PU_MM2;
  TH1F *N_Vtx_BX0_true_MM2;

  TH1F *N_Vtx_BX_PU_MT2;
  TH1F *N_Vtx_BX_true_MT2;
  TH1F *N_Vtx_BX0_PU_MT2;
  TH1F *N_Vtx_BX0_true_MT2;

  TH1F *N_Vtx_BX_PU_ML3;
  TH1F *N_Vtx_BX_true_ML3;
  TH1F *N_Vtx_BX0_PU_ML3;
  TH1F *N_Vtx_BX0_true_ML3;

  TH1F *N_Vtx_BX_PU_MT3;
  TH1F *N_Vtx_BX_true_MT3;
  TH1F *N_Vtx_BX0_PU_MT3;
  TH1F *N_Vtx_BX0_true_MT3;

  TH1F *N_Vtx_BX_PU_EL3;
  TH1F *N_Vtx_BX_true_EL3;
  TH1F *N_Vtx_BX0_PU_EL3;
  TH1F *N_Vtx_BX0_true_EL3;

  TH1F *N_Vtx_BX_PU_EM3;
  TH1F *N_Vtx_BX_true_EM3;
  TH1F *N_Vtx_BX0_PU_EM3;
  TH1F *N_Vtx_BX0_true_EM3;

  TH1F *N_Vtx_BX_PU_ET3;
  TH1F *N_Vtx_BX_true_ET3;
  TH1F *N_Vtx_BX0_PU_ET3;
  TH1F *N_Vtx_BX0_true_ET3;

  TH1F *N_Vtx_BX_PU_Cut;
  TH1F *N_Vtx_BX_true_Cut;
  TH1F *N_Vtx_BX0_PU_Cut;
  TH1F *N_Vtx_BX0_true_Cut;
