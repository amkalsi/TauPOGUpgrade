#ifndef __MUON_2_FAKERATE_H_                                                                                                                                          
#define __MUON_2_FAKERATE_H_ 
...
class MuTauFakeRate2to3 {
    public:
        MuTauFakeRate2to3(std::string prefix, edm::Service<TFileService> fs, const edm::ParameterSet& cfg);
      ~MuTauFakeRate2to3();
