#ifndef __DECAYMODE_NEW_OTHERS_H_                                                                                                                                          
#define __DECAYMODE_NEW_OTHERS_H_ 
...
class NEWDecayOthers {
    public:
        NEWDecayOthers(std::string prefix,edm::Service<TFileService> fs, const edm::ParameterSet& cfg);
      ~NEWDecayOthers();
