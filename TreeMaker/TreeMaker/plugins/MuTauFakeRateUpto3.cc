...
MuTauFakeRateUpto3::MuTauFakeRateUpto3(std::string prefix,edm::Service<TFileService> fs,const edm::ParameterSet& iConfig)
{
...
MuTauFakeRateUpto3::~MuTauFakeRateUpto3()
{
...
void MuTauFakeRateUpto3::Fill(const edm::Event& iEvent) {
  using namespace edm;
  using namespace std;
...
bool MuTauFakeRateUpto3::OverlapWithGenTauForOther(double Taueta , double Tauphi , edm::Handle<reco::PFTauCollection> taujetcol, edm::Handle<reco::PFTauDiscriminator>  disc ,int &index ) {
...
bool MuTauFakeRateUpto3::IsZMuMu(edm::Handle<reco::GenParticleCollection> genParticles){
   bool isZMuMu = false;
...
bool MuTauFakeRateUpto3::OverlapWithGenMu(double Taueta , double Tauphi ,edm::Handle<reco::GenParticleCollection> genParticles ,int  &index ) {
  double drtmp = _TauToGenMatchingDeltaR;
  int tmpindex =0 ;
  bool genTaufound = false;
