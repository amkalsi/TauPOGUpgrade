...
//  Handle<reco::PFTauDiscriminator> _hpsTau,_hpsTau1,_hpsTau2,_hpsTau3,_chargedIsoPtSum,_neutralIsoPtSum,_pucorrPtSum,_rawCharged;
  ...
  Handle<reco::PFTauDiscriminator> _dmf,_mv1,_mv2,_mv3,_mv31,_mv32,_ev1,_ev2,_ev3,_iso1,_iso2,_iso3,_iso4,_iso5,_iso6, _hpsTau,_hpsTau1,_hpsTau2,_hpsTau3,_chargedIsoPtSum,_neutralIsoPtSum,_pucorrPtSum,_rawCharged ,  _rawpu, _rawn , _rawc,_nw1,_nw2,_nw1nq,_nw2nq,_hw1,_hw2,_hw1nq,_hw2nq, _h1,_enew ; 
  ...
  TH1F *h_MIsoPtSum_DR;
  TH1F *h_TIsoPtSum_DR;
  TH1F *h_EMUveto_Response;
  TH1F *h_EMUveto_TauPt;
  TH1F *h_EMUveto_TauEta;
  TH1F *h_EMUveto_TauPhi;

  TH1F *h_EMUveto_JetPt;
  TH1F *h_EMUveto_JetEta;
  TH1F *h_EMUveto_JetPhi;

  TH1F *h_EMUveto_GenJetPt;
  TH1F *h_EMUveto_GenJetEta;
  TH1F *h_EMUveto_GenJetPhi;

  TH1F *h_EMUveto_NVtx;
  TH1F *h_EMUveto_NGood;
  TH1F *h_EMUveto_NBest;
  TH1F *h_EMUveto_DR;
